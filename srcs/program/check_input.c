...
/*   Updated: 2025/04/19 19:16:13 by aaljazza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int check_input(char **argv)
{
    if (input_content (argv[1]) == 0 || ft_atoi (argv[1]) <= 0 || ft_atoi (argv[1]) > PHILO_MAX)
        return (write_error("\e[31m invalid philos number \e[0m"));
    if (input_content (argv[2]) == 0 ||  ft_atoi (argv[2]) < 60)
        return (write_error("\e[31m invalid time to die \e[0m"));
    if (input_content (argv[3]) == 0 || ft_atoi (argv[3]) < 60)
        return (write_error("\e[31m invalid time to eat \e[0m"));
    if (input_content (argv[4]) == 0 || ft_atoi (argv[4]) < 60)
        return (write_error("\e[31m invalid time to sleep \e[0m"));
    if ( argv[5] && (input_content (argv[5]) == 0 || ft_atoi (argv[5]) < 0 )) // if argv[5] exist but < 0
        return (write_error("\e[31m invalid num of times each philo should eat \e[0m"));
    return (0);
}
