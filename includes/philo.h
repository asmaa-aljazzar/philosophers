...
typedef struct s_philo
{
	...
	// one philo eating from the pasta
	pthread_mutex_t	*pasta_lock;
	// ensuring that one thread is printing at the time
	...
	int				*dead;
	// size_t because it store the timestamps
	// raquire an unsigned type and enough capacity
	size_t			start_time;
	size_t			last_meal;
...
void	philos_init(t_philo *philo, t_program *program,
